functions = [
    ...
    {
        "name": "generate_image",
        "description": "Generate images based on a text prompt. The prompt should use simple english and limited to 20 words. Use when the user asks you to generate, send, give, (and any other synonyms) an image. Craft your prompt by 'showing' and not 'telling' the imagery. The text to image model doesn't hold a context and remember between images, so each image is a new image.",
        "parameters": {
            "type": "object",
            "properties": {
                "prompt": {
